 ...
 */
public class GSTConsXref extends SQLGeneratorBase implements SQLGenerator {

    private String readFilePath = "C://Users//Michal Bluj//Desktop//UCR - Guest data/gst_cons_xref.csv";

    private static final String[] FILE_HEADER_MAPPING = {"i_dmid","i_xref_dmid","c_quality_cd","d_timestamp"};
    ...
    private String generateInsertLine(CSVRecord record) {
        return "Insert into caesars.gst_id_xref (i_dmid,i_xref_dmid,c_quality_cd,d_timestamp) VALUES (" +
